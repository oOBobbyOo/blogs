import { _ as _sfc_main$2, f as formatDate, g as getYear, i as isFuture, a as isSameYear } from './WrapperPost-bPrDeG4J.js'
import { computed, createBlock, createCommentVNode, createVNode, defineComponent, mergeProps, openBlock, resolveDynamicComponent, toDisplayString, unref, useSSRContext, withCtx } from 'vue'
import { ssrInterpolate, ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderStyle, ssrRenderVNode } from 'vue/server-renderer'
                  ...
                  createVNode('div', { flex: '~ gap-2 items-center' }, [
                    ...
                    route.duration
                      ? (openBlock(), createBlock('span', {
                          ...
                          'text-sm': '',
                          'op40': '',
                        }, `· ${toDisplayString(route.duration)}`, 1))
                      : createCommentVNode('', true),
                    route.platform
                      ? (openBlock(), createBlock('span', {
                          'key': 4,
                          ...
                          'text-sm': '',
                          'op40': '',
                        }, `· ${toDisplayString(route.platform)}`, 1))
                      : createCommentVNode('', true),
                    route.place
                      ? (openBlock(), createBlock('span', {
                          'key': 5,
